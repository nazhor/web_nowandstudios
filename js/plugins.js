    ...
    Plugin.prototype.structure = function() {
        ...
        if (this.s.controls && this.$items.length > 1) {
            controls = '<div class="lg-actions">' +
                '<div class="lg-prev lg-icon"><i class="fa fa-angle-left"></i>' + this.s.prevHtml + '</div>' +
                '<div class="lg-next lg-icon"><i class="fa fa-angle-right"></i>' + this.s.nextHtml + '</div>' +
                '</div>';
        }
		
		/*
		                '<div class="lg-prev lg-icon fa fa-angle-left">' + this.s.prevHtml + '</div>' +
                '<div class="lg-next lg-icon fa fa-angle-right">' + this.s.nextHtml + '</div>' +
                '</div>';
		*/
